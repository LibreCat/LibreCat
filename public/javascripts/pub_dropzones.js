		...
		init: function(){
	        ...
	        this.on("uploadprogress", function(file,progress,bytesSent){
		   	...
		   	this.on("success", function(file,response){
	            ...
	            var supervisor = Dropzone.createElement("<div class='form-group'><label class='col-sm-2 control-label'>Supervisor<span class='starMandatory'></span></label><div class='col-sm-5'><input type='text' name='supervisor.0.first_name' class='form-control' placeholder='First Name' required /></div><div class='col-sm-5'><input type='text' name='supervisor.0.last_name' class='form-control' placeholder='Last Name' /></div></div>");
	            form.appendChild(supervisor);
	            
	            var supervisor1 = Dropzone.createElement("<div class='form-group'><label class='col-sm-2 control-label'>2. Supervisor</label><div class='col-sm-5'><input type='text' name='supervisor.1.first_name' class='form-control' placeholder='First Name' /></div><div class='col-sm-5'><input type='text' name='supervisor.1.last_name' class='form-control' placeholder='Last Name' /></div></div>");
	            form.appendChild(supervisor1);
	            
	            var supervisor2 = Dropzone.createElement("<div class='form-group'><label class='col-sm-2 control-label'>3. Supervisor</label><div class='col-sm-5'><input type='text' name='supervisor.2.first_name' class='form-control' placeholder='First Name' /></div><div class='col-sm-5'><input type='text' name='supervisor.2.last_name' class='form-control' placeholder='Last Name' /></div></div>");
	            form.appendChild(supervisor2);
