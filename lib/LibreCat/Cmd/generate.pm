...
sub _generate_package_json {
    ...
    my $json = {
      ...
      "scripts" => {
        ...
        "prefix-core-css" => "postcss -u autoprefixer --autoprefixer.browsers '> 5%' -o $root_main_css $root_main_css",
        "prefix-css" => "postcss -u autoprefixer --autoprefixer.browsers '> 5%' -o $main_css $main_css",
        "core-css-dev" => "nodemon -e $root_scss_path -x 'node_modules/.bin/npm-run-all build-core-css-dev prefix-core-css'",
        "core-css" => "nodemon -e $root_scss_path -x 'node_modules/.bin/npm-run-all build-core-css prefix-core-css'",
