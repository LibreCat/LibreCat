...
note("search: Peeters Netherlands");
{
    ...
    $mech->content_contains('Regime change at a distance:', 'got the right result');
}
...
note("search: Markovic, Dida space");
{
    ...
    # check if all links work
    $mech->content_contains('Large-scale retrospective relative spectro-photometric self-calibration in space', 'got the right result');
}
